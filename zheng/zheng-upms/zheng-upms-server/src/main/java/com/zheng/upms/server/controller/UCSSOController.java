...
import com.zheng.upms.server.shiro.UcenterSessionDao;
 ...
 */
@Controller
@RequestMapping("/ucsso")
@Api(value = "单点登录管理", description = "单点登录管理")
public class UCSSOController extends BaseController {

    private final static Logger _log = LoggerFactory.getLogger(UCSSOController.class);
    // 全局会话key
    ...
    @Autowired
    UcenterSessionDao upmsSessionDao;
    ...
    public String index(HttpServletRequest request) throws Exception {
        ...
        return "redirect:/ucsso/login?backurl=" + URLEncoder.encode(backurl, "utf-8");
    }
