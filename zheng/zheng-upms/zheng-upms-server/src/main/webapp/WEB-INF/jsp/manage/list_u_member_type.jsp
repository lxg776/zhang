...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                <li><i class="icon-home"></i> <a href="index.html">会员管理</a> <i
                ...
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon white align-justify"></i><span
                            class="break"></span>会员类型管理
                    </h2>
                    <div class="box-icon">
                        <a href="${ctx}/manage/member/editUserMember?userId=${userId}" style="color: #fff">添加</a>
                    </div>
                </div>
                <div class="box-content">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 200px;">会员类型名称</th>
                            <th style="width: 200px;">开通时间</th>
                            <th style="width: 200px;">截止时间</th>
                            <th style="width: 200px;">创建时间</th>
                            <th style="width: 200px;">优先等级</th>
                        ...
                        <c:forEach var="item" items="${dataList}" >
                            <tr>
                                ...
                                <td style="width: 200px;">${item.memberTypeName}</td>
                                <td style="width: 200px;">${item.begTime}</td>
                                ...
                                <td style="width: 400px;"><a href="${ctx}/manage/member/editUserMember?id=${item.id}&&userId=${userId}" style="color: #0033FF">编辑</a>
