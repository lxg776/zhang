...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                <li><i class="icon-home"></i> <a href="index.html">问候语列表</a> <i
                ...
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon white align-justify"></i><span
                            class="break"></span>问候语
                    </h2>
                    <div class="box-icon">
                        <a href="${ctx}/manage/greeting/edit" style="color: #FFF">添加</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="item" items="${page.dataList}" >
                            <tr>
                                ...
                                <td style="width: 100px;"><c:if test="${item.showStatus == 0}">隐藏</c:if>
                                    <c:if test="${item.showStatus == 1}">显示</c:if>
                                </td>
                                <td style="width: 200px;">${item.sort}</td>
                                <td style="width: 200px;"><fmt:formatDate value="${item.createTime}" pattern="yyyy/MM/dd  HH:mm:ss" /></td>
                                <td style="width: 100px;"><a href="${ctx}/manage/greeting/edit?id=${item.id}" style="color: #0033FF">编辑</a>
