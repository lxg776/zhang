                ...
                <div class="box-content">
                    <form action="saveField" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="typeahead">报名时间 </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead"
                                           name="show_field_name" value="{vo.show_field_name}" data-provide="typeahead">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="typeahead">报名截止时间 </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead"
                                           name="show_field_name" value="{vo.show_field_name}" data-provide="typeahead">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id="selectError3" name="keyWord">
                                        <option value="online">显示</option>
                                        <option value="cn">隐藏</option>
