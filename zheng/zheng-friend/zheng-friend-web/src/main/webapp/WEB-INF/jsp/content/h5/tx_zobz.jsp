    ...
    <ul class="aui-list aui-form-list">
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                    <input type="text" placeholder="填写工作区域">
                </div>
        ...
        <li class="aui-list-item">
            <div class="aui-list-item-inner">
                ...
                <div class="aui-list-item-input">
                    <label><input class="aui-radio" type="radio" name="demo1" checked>不限</label>
                    <label><input class="aui-radio" type="radio" name="demo1">没有</label>
                    <label><input class="aui-radio" type="radio" name="demo1">有</label>
                </div>
            </div>
        </li>
