...
<form id="form" action="${policy.action}" method="post" enctype="multipart/form-data">

    <input id="dir" type="hidden" name="dir" value="${policy.dir}"/>
    <p>key : <input id="key" type="text" name="key"/></p>
    <p>policy : <input id="policy" type="text" name="policy" value="${policy.policy}"/></p>
    <p>OSSAccessKeyId : <input id="OSSAccessKeyId" type="text" name="OSSAccessKeyId" value="${policy.OSSAccessKeyId}"/></p>
    <p>success_action_status : <input type="text" name="success_action_status" value="200"/></p>
    <p>callback : <input type="text" id="callback" name="callback" value="${policy.callback}"/></p>
    <p>signature : <input type="text" id="signature" name="signature" value="${policy.signature}"/></p>
