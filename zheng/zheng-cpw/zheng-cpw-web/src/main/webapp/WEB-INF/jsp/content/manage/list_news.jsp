...
<head>
    ...
    <script type="text/javascript">
        var listUrl = "${ctx}" + "/cpw/newsList?pageNum=";
                ...
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon white align-justify"></i><span
                            class="break"></span>内容管理
                    </h2>
                    <div class="box-icon">
                        <a href="${ctx}/cpw/newsEdit" style="color: #FFF">添加</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="item" items="${page.dataList}" >
                            <tr>
                                ...
                                <td style="width: 200px;">${item.newsColumn}</td>
                                <td style="width: 200px;">${item.createTime}</td>
                                <td style="width: 100px;"><a href="${ctx}/cpw/newsEdit?id=${item.id}" style="color: #0033FF">编辑</a>
