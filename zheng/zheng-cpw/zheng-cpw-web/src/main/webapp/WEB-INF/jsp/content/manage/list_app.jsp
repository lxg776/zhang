...
<head>
    ...
    <script type="text/javascript">
        var listUrl = "${ctx}" + "/cpw/applist?pageNum=";
                ...
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon white align-justify"></i><span
                            class="break"></span>用户管理
                    </h2>
                    <div class="box-icon">
                        <a href="${ctx}/cpw/appEdit" style="color: #FFF">添加</a>
                ...
                <div class="box-content">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 100px;">系统key</th>
                            <th style="width: 100px;">苹果审核状态</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;">${item.sysName}</td>
                                <td style="width: 200px;">${item.sysKey}</td>
                                    <td style="width: 100px;">
                                        <c:if test="${item.sysState =='1' }">通过</c:if>
                                        <c:if test="${item.sysState =='0' }">不通过</c:if>
                                    </td>

                                <td style="width: 200px;"><fmt:formatDate value="${item.createTime}" pattern="yyyy/MM/dd  HH:mm:ss" /></td>
                                <td style="width: 100px;"><a href="${ctx}/cpw/appEdit?id=${item.id}" style="color: #0033FF">编辑</a>
